...
describe User do
  ...
  describe "when email address is already taken" do
    ...
    it { should_not be_valid } #because user model has uniqueness validation set to case_sensitve: false
  end
  ...
  describe "micropost associations" do
    ...
    it "should destroy associated microposts" do
      microposts = @user.microposts.dup #without duplicating microposts array, you wouldn't be able to check if an id is nil, because 'micropost.id' would no longer exist. 
      @user.destroy
